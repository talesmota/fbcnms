...
test('clicking the add button adds new textboxes', () => {
  ...
  } = render( /*#__PURE__*/React.createElement(LabelsEditor, commonProps));
...
test('typing into a key field edits the key of a label', () => {
  const {
    getByDisplayValue
  } = render( /*#__PURE__*/React.createElement(LabelsEditor, _extends({}, commonProps, {
    labels: {
      testKey1: 'testVal1',
      testKey2: 'testVal2'
    }
