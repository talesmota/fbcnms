...
import { blue05, blue30, blue60, blueGrayDark, fadedBlue, gray0, gray00, gray1, gray13, gray50, primaryText, red, redwood, white } from './colors';
...
export default createMuiTheme({
  ...
  palette: {
    ...
    typography: { ...SymphonyTheme.typography
    },
    red: red,
    redwood: redwood,
    dark: '#1d2129',
